...
Based on the above changes, create a single git commit following the Conventional Commits format. Ensure that the commit message captures the essence of the changes made in the conversation.
